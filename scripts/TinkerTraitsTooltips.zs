...
<contenttweaker:trait_prickly>.addTooltip(format.red("Deals armor-piercing damage to enemies hit."));
...
<contenttweaker:trait_radioactive>.addTooltip(format.red("Randomly causes hunger or radiation poisoning"));
