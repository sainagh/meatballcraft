...
bot8.addItemOutput(SuperEnchantedItem(<thebetweenlands:ancient_chestplate>.withTag({display: {Name:"§6§oEonic Chestplate§r",Lore:["§d§o超限附魔§r"]}}), enclistEonArmorWrapped).getItem());
bot8.build();
...
bot9.addItemOutput(SuperEnchantedItem(<thebetweenlands:ancient_helmet>.withTag({display: {Name:"§6§oEonic Helmet§r",Lore:["§d§o超限附魔§r"]}}), enclistEonArmorWrapped).getItem());
bot9.build();
...
bot10.addItemOutput(SuperEnchantedItem(<thebetweenlands:ancient_leggings>.withTag({display: {Name:"§6§oEonic Leggings§r",Lore:["§d§o超限附魔§r"]}}), enclistEonArmorWrapped).getItem());
bot10.build();
...
bot11.addItemOutput(SuperEnchantedItem(<thebetweenlands:ancient_boots>.withTag({display: {Name:"§6§oEonic Boots§r",Lore:["§d§o超限附魔§r"]}}), enclistEonArmorWrapped).getItem());
bot11.build();
