...
events.onPlayerInteractEntity(function(event as PlayerInteractEntityEvent) {
  ...
  if (!isNull(heldItem) && heldItem.definition.id.matches(<contenttweaker:investiture_of_the_eleint>.definition.id)) {
    ...
    Commands.call("/entitydata @e[r=15] {CustomName:\"飞升伊莱\",ForgeCaps:{\"twilightforest:cap_shield\":{tempshields:200,permshields:200}},Tags:[\"dragonascendedeleint\"]}", event.player, event.world, true, true);
