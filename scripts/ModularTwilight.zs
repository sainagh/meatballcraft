...
reci1.addItemOutput(SuperEnchantedItem(<twilightforest:block_and_chain>.withTag({display: {Name:"§6§oMorning Star§r",Lore:["§d§o超限附魔§r"]}}), enclistMorningStarWrapped).getItem());
reci1.build();
...
reci2.addItemOutput(SuperEnchantedItem(<twilightforest:minotaur_axe>.withTag({display: {Name:"§6§oAxe of Savagery§r",Lore:["§d§o超限附魔§r"]}}), enclistSavageAxeWrapped).getItem());
reci2.build();
...
reci3.addItemOutput(SuperEnchantedItem(<twilightforest:giant_sword>.withTag({display: {Name:"§6§oBig Bertha§r",Lore:["§d§o超限附魔§r"]}}), enclistBigBerthaWrapped).getItem());
reci3.build();
