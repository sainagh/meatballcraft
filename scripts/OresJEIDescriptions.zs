...
mods.jei.JEI.addDescription(<aether_legacy:ambrosium_shard>,["使用圣石工具时会掉落。","","该矿物生成与天境。"]);
mods.jei.JEI.addDescription(<aether_legacy:enchanted_gravitite>,["该矿物生成与天境。"]);
mods.jei.JEI.addDescription(<aether_legacy:zanite_gemstone>,["该矿物生成与天境。"]);
mods.jei.JEI.addDescription(<aoa3:amethyst>,["发现于Y=13到Y=31之间。","","可生成于结构中的奖励箱。","","可发现于宝石袋。","","可与金属收藏家交易获得40铜币。","","Can be dropped by a Bane.","","Mobs killed by a Crystaneer have a chance of dropping it." ]);
...
mods.jei.JEI.addDescription(<aoa3:limonite_ingot>,["Found between Y=9 and Y=70.","","Can be found in a Treasure Box or a Shiny Box.","","Can be found in Loot Chests from Structures.","","可与金属收藏家交易获得15铜币。","","Can be dropped by Chimeras.","","","","- Most written by Bluecat"]);
...
mods.jei.JEI.addDescription(<contenttweaker:metagabbro>,["发现于Y=50以下 on Orcus."]);
mods.jei.JEI.addDescription(<contenttweaker:onyx>,["发现于Y=50以下 on Europa."]);
mods.jei.JEI.addDescription(<contenttweaker:pink_marble>,["发现于Y=50以下 on Hator."]);
mods.jei.JEI.addDescription(<contenttweaker:recursive_powder>,["Obtained from the first mythic shell puzzle"]);
mods.jei.JEI.addDescription(<contenttweaker:serpentine>,["发现于Y=50以下 on Osiris."]);
mods.jei.JEI.addDescription(<contenttweaker:travertine>,["发现于Y=50以下 on Ptah."]);
...
mods.jei.JEI.addDescription(<draconicevolution:draconium_dust>,["发现于Y=8以下 in the Overworld.","","Can be found at every level in the End and the Nether." ]);
