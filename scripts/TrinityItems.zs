...
summonsofragnarok.itemRightClick = function(stack, world, player, hand) {
    ...
    if(player.getDimension() != 426) {
        player.sendChat("用诸神黄昏印记填补迷道撕裂器在秘界留下的中央5x5区域");
        return "FAIL";
    }
    player.sendChat("用诸神黄昏印记填补迷道撕裂器在秘界留下的中央5x5区域");
    ...
    if (getBlockMatchAtPosition("contenttweaker:ragnarok_sigil", playerPos, [0,0,1], world) == 0){
        player.sendChat("缺失诸神黄昏印记：[0,0,1]");
        return "FAIL";
    }
    if (getBlockMatchAtPosition("contenttweaker:ragnarok_sigil", playerPos, [0,0,-1], world) == 0){
        player.sendChat("缺失诸神黄昏印记：[0,0,-1]");
    ...
    if (getBlockMatchAtPosition("contenttweaker:ragnarok_sigil", playerPos, [2,0,0], world) == 0){
        player.sendChat("缺失诸神黄昏印记：[2,0,0]");
        return "FAIL";
    }
    if (getBlockMatchAtPosition("contenttweaker:ragnarok_sigil", playerPos, [-2,0,0], world) == 0){
        player.sendChat("缺失诸神黄昏印记：[-2,0,0]");
    ...
    if (getBlockMatchAtPosition("contenttweaker:ragnarok_sigil", playerPos, [0,0,2], world) == 0){
        player.sendChat("缺失诸神黄昏印记：[0,0,2]");
        return "FAIL";
    }
    if (getBlockMatchAtPosition("contenttweaker:ragnarok_sigil", playerPos, [0,0,-2], world) == 0){
        player.sendChat("缺失诸神黄昏印记：[0,0,-2]");
    ...
    if (getBlockMatchAtPosition("contenttweaker:ragnarok_sigil", playerPos, [1,0,1], world) == 0){
        player.sendChat("缺失诸神黄昏印记：[1,0,1]");
        return "FAIL";
    }
    if (getBlockMatchAtPosition("contenttweaker:ragnarok_sigil", playerPos, [-1,0,1], world) == 0){
        player.sendChat("缺失诸神黄昏印记：[-1,0,1]");
    ...
    if (getBlockMatchAtPosition("contenttweaker:ragnarok_sigil", playerPos, [2,0,2], world) == 0){
        player.sendChat("缺失诸神黄昏印记：[2,0,2]");
        return "FAIL";
    }
    if (getBlockMatchAtPosition("contenttweaker:ragnarok_sigil", playerPos, [-2,0,2], world) == 0){
        player.sendChat("缺失诸神黄昏印记：[-2,0,2]");
    ...
    if (getBlockMatchAtPosition("contenttweaker:ragnarok_sigil", playerPos, [1,0,2], world) == 0){
        player.sendChat("缺失诸神黄昏印记：[1,0,2]");
        return "FAIL";
    }
    if (getBlockMatchAtPosition("contenttweaker:ragnarok_sigil", playerPos, [-1,0,2], world) == 0){
        player.sendChat("缺失诸神黄昏印记：[-1,0,2]");
    ...
    if (getBlockMatchAtPosition("contenttweaker:ragnarok_sigil", playerPos, [2,0,1], world) == 0){
        player.sendChat("缺失诸神黄昏印记：[2,0,1]");
        return "FAIL";
    }
    if (getBlockMatchAtPosition("contenttweaker:ragnarok_sigil", playerPos, [-2,0,1], world) == 0){
        player.sendChat("缺失诸神黄昏印记：[-2,0,1]");
    ...
    Commands.call("/summon divinerpg:rainbour ~10 ~3 ~ {CustomName:\"尼德霍格\",Invulnerable:1,PersistenceRequired:1,ActiveEffects:[{Id:14,Amplifier:0,Duration:999999},{Id:24,Amplifier:0,Duration:999999}],Passengers:[{id:\"minecraft:villager\",CustomName:\"拉塔托斯克\",Invulnerable:1,PersistenceRequired:1,ActiveEffects:[{Id:14,Amplifier:0,Duration:999999},{Id:24,Amplifier:0,Duration:999999}],Offers:{Recipes:[{buy:{id:\"botania:infinitefruit\",Count:1},sell:{id:\"contenttweaker:breath_of_ragnarok\",Count:1},rewardExp:0b,maxUses:9999999}]}}]}", player, world, false, true);
    stack.shrink(1);
    return "PASS";
