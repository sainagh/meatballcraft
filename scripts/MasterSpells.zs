...
masterspellordo.itemRightClick = function(stack, world, player, hand) {
	...
	player.sendChat("或许在冥界、苍穹之外，能为失落附魂之石派上用场");
...
masterspellaversio.itemRightClick = function(stack, world, player, hand) {
	...
	Commands.call("summon thaumcraft:cultistknight ~ ~4 ~ {HandItems:[{Count:1,id:\"aoa3:bloodstone_sword\"},{}],HandDropChances:[0.2f,0.0f],Attributes:[{Name:generic.maxHealth, Base:10000.0},{Name:generic.attackDamage, Base:30.0}],Health:10000f,CustomName:\"堕落狂战士\",ArmorItems:[{Count:1,id:\"iceandfire:armor_red_boots\"},{Count:1,id:\"iceandfire:armor_red_leggings\"},{Count:1,id:\"iceandfire:armor_red_chestplate\"},{Count:1,id:\"iceandfire:armor_red_helmet\"}],ArmorDropChances:[0.1f,0.1f,0.1f,0.1f]}", player, world, false, true);
	return "Pass";
};
masterspellaversio.register();

//summon thaumcraft:cultistknight ~ ~4 ~ {HandItems:[{Count:1,id:"aoa3:bloodstone_sword"},{}],HandDropChances:[0.2f,0.0f],Attributes:[{Name:generic.maxHealth, Base:10000.0},{Name:generic.attackDamage, Base:30.0}],Health:10000f,CustomName:"堕落狂战士",ArmorItems:[{Count:1,id:"iceandfire:armor_red_boots"},{Count:1,id:"iceandfire:armor_red_leggings"},{Count:1,id:"iceandfire:armor_red_chestplate"},{Count:1,id:"iceandfire:armor_red_helmet"}],ArmorDropChances:[0.1f,0.1f,0.1f,0.1f]}
...
masterspellvinculum.itemRightClick = function(stack, world, player, hand) {
	...
	Commands.call("summon bewitchment:demoness ~ ~3 ~ {CustomName:\"埃默吉亚，受缚者\",recipeList:{Recipes:[{buy:{id:\"contenttweaker:divine_star\",Count:1},sell:{id:\"contenttweaker:crying_obsidian_powder\",Count:1},rewardExp:0b,maxUses:9999999}]},HandItems:[{Count:4,id:\"contenttweaker:crystaltine_dust\"},{}],HandDropChances:[1.0f,0.0f],ForgeCaps:{\"twilightforest:cap_shield\":{tempshields:4,permshields:4}},Attributes:[{Name:generic.maxHealth, Base:2000.0},{Name:generic.attackDamage, Base:10.0}],Health:2000f}", player, world, false, true);
	return "Pass";
};
...
masterspellherba.itemRightClick = function(stack, world, player, hand) {
	...
	Commands.call("summon divinerpg:kobblin ~ ~3 ~ {HandItems:[{Count:1,id:\"contenttweaker:kobblin_earth\"},{}],HandDropChances:[1.0f,0.0f],CustomName:\"巴卡伊，生灵之壤\",Attributes:[{Name:generic.maxHealth, Base:5000.0},{Name:generic.attackDamage, Base:50.0}],Health:5000f}", player, world, false, true);
	return "Pass";
};
...
masterspellvacuos.itemRightClick = function(stack, world, player, hand) {
	...
	Commands.call("summon mod_lavacow:enigmoth ~ ~3 ~ {HandItems:[{Count:1,id:\"contenttweaker:pale_ore\"},{}],HandDropChances:[1.0f,0.0f],CustomName:\"辐光之蛾\",Attributes:[{Name:generic.maxHealth, Base:100000.0},{Name:generic.attackDamage, Base:50.0}],Health:100000f}", player, world, false, true);
...
masterspellspiritus.itemRightClick = function(stack, world, player, hand) {
	...
	Commands.call("summon ebwizardry:wizard ~ ~3 ~ {CustomName:\"畜牧之灵\",trades:{Recipes:[{buy:{id:\"minecraft:rabbit_foot\",Count:1},buyB:{id:\"minecraft:nether_star\",Count:1},sell:{id:\"contenttweaker:chu_ci_foot\",Count:1},rewardExp:0b,maxUses:9999999},{buy:{id:\"minecraft:rabbit_foot\",Count:1},buyB:{id:\"contenttweaker:eden_star\",Count:1},sell:{id:\"contenttweaker:nanabozho_foot\",Count:1},rewardExp:0b,maxUses:9999999},{buy:{id:\"minecraft:rabbit_foot\",Count:1},buyB:{id:\"contenttweaker:apalachia_star\",Count:1},sell:{id:\"contenttweaker:wenet_foot\",Count:1},rewardExp:0b,maxUses:9999999},{buy:{id:\"minecraft:rabbit_foot\",Count:1},buyB:{id:\"contenttweaker:mortum_star\",Count:1},sell:{id:\"contenttweaker:puca_foot\",Count:1},rewardExp:0b,maxUses:9999999},{buy:{id:\"contenttweaker:spirit_of_worthiness\",Count:1},buyB:{id:\"gendustry:honey_comb\",Damage:14022s,Count:1},sell:{id:\"contenttweaker:gear_of_worthiness\",Count:1},rewardExp:0b,maxUses:9999999}]},ActiveEffects:[{Id:14,Amplifier:0,Duration:999999},{Id:24,Amplifier:0,Duration:999999}]}", player, world, false, true);
	return "Pass";
};
