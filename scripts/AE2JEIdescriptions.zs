...
mods.jei.JEI.addDescription(<appliedenergistics2:storage_cell_1k>,["存储物品，搭载于ME驱动器或ME箱子内。","","可存储64到128组物品，具体数量取决于存储的物品种类。"]);
mods.jei.JEI.addDescription(<appliedenergistics2:storage_cell_4k>,["存储物品，搭载于ME驱动器或ME箱子内。","","可存储256到512组物品，具体数量取决于存储的物品种类。"]);
mods.jei.JEI.addDescription(<appliedenergistics2:storage_cell_16k>,["存储物品，搭载于ME驱动器或ME箱子内。","","可存储1024到2048组物品，具体数量取决于存储的物品种类。"]);
mods.jei.JEI.addDescription(<appliedenergistics2:storage_cell_64k>,["存储物品，搭载于ME驱动器或ME箱子内。","","可存储4096到8192组物品，具体数量取决于存储的物品种类。"]);
mods.jei.JEI.addDescription(<nae2:storage_cell_256k>,["存储物品，搭载于ME驱动器或ME箱子内。","","可存储16k到32k组物品，具体数量取决于存储的物品种类。"]);
mods.jei.JEI.addDescription(<nae2:storage_cell_1024k>,["存储物品，搭载于ME驱动器或ME箱子内。","","可存储64k到128k组物品，具体数量取决于存储的物品种类。"]);
mods.jei.JEI.addDescription(<nae2:storage_cell_4096k>,["存储物品，搭载于ME驱动器或ME箱子内。","","可存储256k到512k组物品，具体数量取决于存储的物品种类。"]);
mods.jei.JEI.addDescription(<nae2:storage_cell_16384k>,["存储物品，搭载于ME驱动器或ME箱子内。","","可存储1024k到2048k组物品，具体数量取决于存储的物品种类。"]);
...
mods.jei.JEI.addDescription(<appliedenergistics2:part:320>,["在世界中放置进入ME网络的物品。","","无法使用网络中已存储的物品，建立子网络向其中发送物品以实现物品放置。"]);
mods.jei.JEI.addDescription(<appliedenergistics2:part:321>,["在世界中放置进入ME网络的流体。","","无法使用网络中已存储的流体，建立子网络向其中发送流体以实现流体放置。"]);
...
"可以通过量子网桥来运行P2P子网络，但根据子网络的复杂程度，可能会出现异常行为。",
"",
"将无线终端的范围扩展到无限。",
