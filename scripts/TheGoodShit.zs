...
recipes.addShaped(<enderio:item_basic_capacitor:3>.withTag({eiocap: {energy_buffer: 9.00 as float, level: 9.00 as float, energy_intake: 9.00 as float, "enderio:block_combustion_generator/gen": 3.983839 as float}, "enderio:capname": "Cosmic Fracture Capacitor",display:{Name:"寰宇裂隙电容"},"enderio:capno":1,"enderio:glinted":1}),
[[<contenttweaker:cosmic_fracture>, <contenttweaker:dark_capacitor_shard>, <contenttweaker:cosmic_fracture>],
[<contenttweaker:dark_capacitor_shard>, <enderio:item_capacitor_stellar>, <contenttweaker:dark_capacitor_shard>],
[<contenttweaker:cosmic_fracture>, <contenttweaker:dark_capacitor_shard>, <contenttweaker:cosmic_fracture>]]);

recipes.addShaped(<enderio:item_basic_capacitor:3>.withTag({eiocap: {energy_buffer: 12.00 as float, level: 12.00 as float, energy_intake: 12.00 as float, "enderio:block_combustion_generator/gen": 3.983839 as float}, "enderio:capname": "Sacred Cinders Capacitor",display:{Name:"神圣余烬电容"},"enderio:capno":1,"enderio:glinted":1}),
[[<contenttweaker:sacred_cinders_fruit>, <contenttweaker:dark_capacitor_shard>, <contenttweaker:sacred_cinders_fruit>],
[<contenttweaker:dark_capacitor_shard>, <enderio:item_capacitor_stellar>, <contenttweaker:dark_capacitor_shard>],
[<contenttweaker:sacred_cinders_fruit>, <contenttweaker:dark_capacitor_shard>, <contenttweaker:sacred_cinders_fruit>]]);

recipes.addShaped(<enderio:item_basic_capacitor:3>.withTag({eiocap: {energy_buffer: 15.00 as float, level: 15.00 as float, energy_intake: 15.00 as float, "enderio:block_combustion_generator/gen": 3.983839 as float}, "enderio:capname": "Prophetic Capacitor",display:{Name:"预言电容"},"enderio:capno":1,"enderio:glinted":1}),
[[<contenttweaker:prophetic_paper>, <contenttweaker:dark_capacitor_shard>, <contenttweaker:prophetic_paper>],
[<contenttweaker:dark_capacitor_shard>, <enderio:item_capacitor_stellar>, <contenttweaker:dark_capacitor_shard>],
[<contenttweaker:prophetic_paper>, <contenttweaker:dark_capacitor_shard>, <contenttweaker:prophetic_paper>]]);

recipes.addShaped(<enderio:item_basic_capacitor:3>.withTag({eiocap: {energy_buffer: 20.00 as float, level: 20.00 as float, energy_intake: 20.00 as float, "enderio:block_combustion_generator/gen": 3.983839 as float}, "enderio:capname": "Defined Capacitor",display:{Name:"定义电容"},"enderio:capno":1,"enderio:glinted":1}),
[[<contenttweaker:defined_ingot>, <contenttweaker:dark_capacitor_shard>, <contenttweaker:defined_ingot>],
[<contenttweaker:dark_capacitor_shard>, <enderio:item_capacitor_stellar>, <contenttweaker:dark_capacitor_shard>],
[<contenttweaker:defined_ingot>, <contenttweaker:dark_capacitor_shard>, <contenttweaker:defined_ingot>]]);

recipes.addShaped(<enderio:item_basic_capacitor:3>.withTag({eiocap: {energy_buffer: 25.00 as float, level: 25.00 as float, energy_intake: 25.00 as float, "enderio:block_combustion_generator/gen": 3.983839 as float}, "enderio:capname": "Time Lord Capacitor",display:{Name:"时间领主电容"},"enderio:capno":1,"enderio:glinted":1}),
...
recipes.addShaped(<enderio:item_basic_capacitor:3>.withTag({eiocap: {energy_buffer: 30.00 as float, level: 30.00 as float, energy_intake: 30.00 as float, "enderio:block_combustion_generator/gen": 3.983839 as float}, "enderio:capname": "Spren Capacitor",display:{Name:"灵体电容"},"enderio:capno":1,"enderio:glinted":1}),
